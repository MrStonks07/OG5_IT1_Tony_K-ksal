...
public class TankSimulator extends Frame {
	...
	public Button btnZuruecksetzten = new Button("Zurücksetzten");
	...
	public TankSimulator() {
		...
		this.pnlSouth.add(this.btnZuruecksetzten);
		...
		this.btnZuruecksetzten.addActionListener(myActionListener);
	}

	public static void main(String argv[]) {
		new TankSimulator();
		//shout out to @Tanksimulator even if we don't know you
	}
}